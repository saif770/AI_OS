...
Generated: 2026-07-03T21:35:29.635677

## Project

- **name**: AI-OS
- **root**: G:\My Drive\AI_OS\AI-OS

## Language

- **primary_language**: Python
- **total_source_files**: 164
- **languages**: {'Markdown': 6, 'Python': 156, 'JSON': 2}
- **percentages**: {'Markdown': 3.66, 'Python': 95.12, 'JSON': 1.22}
...
- **latest_commit**: feat(orchestrator): add Orchestrator V1
- **latest_commit_hash**: 8aff3f4ebba8402a1cd976541e5398f118169e58
- **commit_count**: 15
- **tags**: ['improvement-v1', 'memory-v1', 'orchestrator-v1', 'reflection-v1', 'v0.1.0', 'v0.2.0', 'v0.3.0', 'v1.0.0', 'verification-v2-complete']
- **status**: ['M .bootstrap/PROJECT_CONTEXT.md', ' M .bootstrap/PROJECT_OVERVIEW.json', ' M .bootstrap/report.json', '?? core/runtime/', '?? tests/unit/runtime/']

## Architecture

- **architecture**: Plugin Architecture
- **confidence**: High
- **reasons**: ['bootstrap/ and core/ packages found']
...
- **npm**: C:\Program Files\nodejs\npm.CMD
- **npx**: C:\Program Files\nodejs\npx.CMD
- **codebase_memory_mcp**: C:\Users\junai\AppData\Local\Programs\codebase-memory-mcp\codebase-memory-mcp.EXE
- **configs**: ['C:\\Users\\junai\\.claude\\.mcp.json']
- **servers**: []
- **available**: True
